    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="<?php echo e(asset('assets/admin/images/1.jpg')); ?>">
            <div class="form-wrapper">
                <h4 class="logo-text mb-15"><?php echo app('translator')->get('Welcome to'); ?> <strong><?php echo e($general->sitename); ?></strong></h4>
                <p><?php echo e($page_title); ?> <?php echo app('translator')->get('to'); ?>  <?php echo e($general->sitename); ?> <?php echo app('translator')->get('dashboard'); ?></p>
                <form action="<?php echo e(route('admin.login')); ?>" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control b-radius--capsule" id="username" value="<?php echo e(old('username')); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>