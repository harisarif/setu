                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" name="name" value="<?php echo e($pdata->name); ?>"
                                required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" name="slug" value="<?php echo e($pdata->slug); ?>"
                                required>
                            </div>
                        </div>
                        <div class="col-md-4">
    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><?php echo e($pdata->name); ?> <?php echo app('translator')->get('Page'); ?></h3>
                ...
                <form action="<?php echo e(route('admin.frontend.manage.section.update',$pdata->id)); ?>" method="post">
                    ...
                    <ol class="simple_with_drop vertical sec-item">
                        ...
                        <li class="highlight icon-move item">
                            ...
                            <span class="d-inline-block text-white mr-auto ml-2"> <?php echo e(@$sections[$sec]['name']); ?></span>
            ...
            <div class="card-body">
                ...
                <ol class="simple_with_no_drop vertical">
                    ...
                    <li class="highlight icon-move clearfix">
                            ...
                            <span class="d-inline-block text-white mr-auto ml-2 mt-2"> <?php echo e($secs['name']); ?></span>
                            <i class="ml-auto d-inline-block remove-icon fa fa-times"></i>
                            <input type="hidden" name="secs[]" value="<?php echo e($k); ?>">
                            <?php if($secs['builder']): ?>
                                <div class="float-right d-inline-block manage-content">
                                    <a href="<?php echo e(route('admin.frontend.sections',$k)); ?>" target="_blank" class="btn btn-outline-light text-center text-white cog-btn"  data-toggle="tooltip" data-original-title="Manage Content">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/admin/frontend/builder/index.blade.php ENDPATH**/ ?>