            ...
            <div class="table-responsive--md table-responsive">
                      ...
                      <?php $__empty_1 = true; $__currentLoopData = $comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $com): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          <tr class="filt">
                              ...
                              <a href="<?php echo e(route('admin.fundrise.edit',['slug' => @$com->campaign->slug,'id'=>@$com->campaign->id])); ?>"><?php echo e(shortDescription($com->campaign->title,20)); ?></a>  
                                </td>
                              <td data-label="<?php echo app('translator')->get('Fullname'); ?>"><?php echo e($com->fullname); ?></td>
                              <td data-label="<?php echo app('translator')->get('Email'); ?>"><?php echo e($com->email); ?></td>
                              <td data-label="<?php echo app('translator')->get('Details'); ?>"><?php echo e(Str::limit($com->details,30)); ?></td>
                              <td data-label="<?php echo app('translator')->get('Review Date'); ?>"><?php echo e($com->created_at->diffForHumans()); ?></td>
                              <td data-label="<?php echo app('translator')->get('Status'); ?>"> 
                               
                                <span class="text--small badge font-weight-normal <?php echo e($com->published == 1 ? 'badge--success':($com->published == 2 ? "badge--danger":'badge--warning')); ?>"><?php echo e($com->published == 1 ? 'Published':($com->published == 2 ? 'Rejected': 'Pending')); ?></span>
                              ...
                              <a href="javascript:void(0)" class="icon-btn btn--primary editbtn  ml-1" data-toggle="tooltip" title="" data-original-title="Edit" data-comment_id="<?php echo e($com->id); ?>" data-description="<?php echo e($com->details); ?>" data-title ="<?php echo e($com->campaign->title); ?>" data-status = "<?php echo e($com->published); ?>">
                                    <i class="la la-pen"></i>
                                </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/setu.foundation/public_html/core/resources/views/admin/fundrise/review.blade.php ENDPATH**/ ?>