                            ...
                            <?php $__currentLoopData = $extensions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extension): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td data-label="<?php echo app('translator')->get('Extension'); ?>">
                                        <div class="user">
                                            <div class="thumb"><img src="<?php echo e(getImage(imagePath()['extensions']['path'] .'/'. $extension->image,'36x36')); ?>" alt="<?php echo e($extension->name); ?>" class="plugin_bg"></div>
                                            <span class="name"><?php echo e($extension->name); ?></span>
                                        </div>
                                    </td>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                        <button type="button" class="icon-btn ml-1 editBtn"
                                                data-name="<?php echo e($extension->name); ?>"
                                        ...
                                        <button type="button" class="icon-btn btn--dark ml-1 helpBtn"
                                                data-description="<?php echo e($extension->description); ?>"
                                                data-support="<?php echo e($extension->support); ?>"
                                        ...
                                        <?php if($extension->status == 0): ?>
                                            <button type="button"
                                                    ...
                                                    data-id="<?php echo e($extension->id); ?>" data-name="<?php echo e($extension->name); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.extensions.activate')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <p><?php echo app('translator')->get('Are you sure to activate'); ?> <span
                                    class="font-weight-bold extension-name"></span> <?php echo app('translator')->get('extension?'); ?></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn--dark" data-dismiss="modal"><?php echo app('translator')->get('Close'); ?></button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.extensions.deactivate')); ?>" method="POST">
                    ...
                    <input type="hidden" name="id">
                    <div class="modal-body">
                        <p><?php echo app('translator')->get('Are you sure to disable'); ?> <span
                                    class="font-weight-bold extension-name"></span> <?php echo app('translator')->get('extension?'); ?></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn--dark" data-dismiss="modal"><?php echo app('translator')->get('Close'); ?></button>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/setu.foundation/public_html/core/resources/views/admin/extension/index.blade.php ENDPATH**/ ?>