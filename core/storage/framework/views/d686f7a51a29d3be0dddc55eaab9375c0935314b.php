                        ...
                        <table class="table table--light style--two custom-data-table">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $pdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Slug'); ?>"><?php echo e($data->slug); ?></td>


                                    <td data-label="<?php echo app('translator')->get('Action'); ?>">

                                        <a href="<?php echo e(route('admin.frontend.manage.section', $data->id)); ?>"
                                           class="icon-btn btn--primary ml-1"  data-toggle="tooltip" data-original-title="Edit"><i class="la la-pen"></i></a>
                ...
                <form action="<?php echo e(route('admin.frontend.manage.pages.save')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg" name="name" value="<?php echo e(old('name')); ?>"
                                   required>
                        </div>

                        <div class="form-group">
                            <label> <?php echo app('translator')->get('Slug'); ?> </label>
                            <input type="text" class="form-control form-control-lg" name="slug" value="<?php echo e(old('slug')); ?>"
                                   required>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/admin/frontend/builder/pages.blade.php ENDPATH**/ ?>