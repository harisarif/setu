                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <small class="mt-2 text-facebook"><?php echo app('translator')->get('Supported files:'); ?> <b><?php echo app('translator')->get('jpeg, jpg'); ?></b>. <?php echo app('translator')->get('Image will be resized into'); ?> <?php echo e(imagePath()['seo']['size']); ?>px </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group ">
                                    ...
                                    <small class="ml-2 mt-2 text-facebook"><?php echo app('translator')->get('Separate multiple keywords by'); ?> <code>,</code><?php echo app('translator')->get('(comma) or'); ?> <code><?php echo app('translator')->get('enter'); ?></code> <?php echo app('translator')->get('key'); ?></small>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" rows="3" class="form-control" placeholder="SEO meta description" required><?php echo e(@$seo->data_values->description); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold"><?php echo app('translator')->get('Social Title'); ?></label>
                                    <input type="text" class="form-control" placeholder="Social Share Title" name="social_title" value="<?php echo e(@$seo->data_values->social_title); ?>" required/>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold"><?php echo app('translator')->get('Social Description'); ?></label>
                                    <textarea name="social_description" rows="3" class="form-control" placeholder="Social Share  meta description" required><?php echo e(@$seo->data_values->social_description); ?></textarea>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/admin/frontend/seo.blade.php ENDPATH**/ ?>