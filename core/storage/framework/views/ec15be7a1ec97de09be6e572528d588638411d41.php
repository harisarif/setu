                        ...
                        <form action="<?php echo e(route('admin.frontend.sections.content', $key)); ?>" method="POST"
                            ...
                            <div class="row">
                                <?php
                                    $imgCount = 0;
                                ?>
                                <?php $__currentLoopData = $section->content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($k == 'images'): ?>
                                        <?php
                                                    ...
                                                    <div class="image-upload">
                                                        <div class="thumb">
                                                            ...
                                                            <div class="avatar-edit">
                                                                ...
                                                                <small class="mt-2 text-facebook"><?php echo app('translator')->get('Supported files:'); ?> <b><?php echo app('translator')->get('jpeg, jpg, png'); ?></b>.
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn--dark btn-block btn-lg"><?php echo app('translator')->get('Update'); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <?php if(@$section->element): ?>
                                ...
                                <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($k !='modal'): ?>
                                        <?php if($type=='text' || $type=='icon'): ?>
                                            <th scope="col"><?php echo e(inputTitle($k)); ?></th>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                        ...
                                        <td data-label="Image">
                                            <div class="customer-details d-block">
                                                <a href="javascript:void(0)" class="thumb">
                                                    <img src="<?php echo e(getImage('assets/images/frontend/' . $key .'/'. @$data->data_values->$firstKey,@$section->element->images->$firstKey->size)); ?>" alt="image">
                                                </a>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                                    <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($k !='modal'): ?>
                                            <?php if($type == 'text' || $type == 'icon'): ?>
                                                <?php if($type == 'icon'): ?>
                                                    <td data-label="Icon"><?php echo $data->data_values->$k; ?></td>
                                                <?php else: ?>
                                                    <td data-label="<?php echo e(inputTitle($k)); ?>"><?php echo e($data->data_values->$k); ?></td>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <?php echo app('translator')->get('Add New'); ?> <?php echo e(inputTitle($key)); ?> <?php echo app('translator')->get('Item'); ?></h5>
                            ...
                            <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($k != 'modal'): ?>
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    ...
                                                    <div class="avatar-edit">
                                                        ...
                                                        <label for="addImage<?php echo e($loop->index); ?>" class="bg--success"><?php echo e(inputTitle($imgKey)); ?></label>
                                                        <small class="mt-2 text-facebook"><?php echo app('translator')->get('Supported files:'); ?> <b><?php echo app('translator')->get('jpeg, jpg, png'); ?></b>.
                                    ...
                                    <?php elseif($type == 'textarea'): ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e(inputTitle($k)); ?></label>
                                            <textarea rows="4" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" required></textarea>
                                        </div>
                                    ...
                                    <?php elseif($type == 'textarea-nic'): ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e(inputTitle($k)); ?></label>
                                            <textarea rows="4" class="form-control nicEdit" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>"></textarea>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e(inputTitle($k)); ?></label>
                                            <input type="text" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" required/>
                                        </div>
        ...
        <div id="updateBtn" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <?php echo app('translator')->get('Update'); ?>  <?php echo e(inputTitle($key)); ?> <?php echo app('translator')->get('Item'); ?></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    ...
                                                    <div class="avatar-edit">
                                                        ...
                                                        <label for="uploadImage<?php echo e($loop->index); ?>" class="bg--success"><?php echo e(inputTitle($imgKey)); ?></label>
                                                        <small class="mt-2 text-facebook"><?php echo app('translator')->get('Supported files:'); ?> <b><?php echo app('translator')->get('jpeg, jpg'); ?>, png</b>.
                                                            <?php if(@$section->element->images->$imgKey->size): ?>
                                                                | <?php echo app('translator')->get('Will be resized to:'); ?> <b><?php echo e(@$section->element->images->$imgKey->size); ?></b> px.
                                                            <?php endif; ?>
                                                        </small>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/admin/frontend/index.blade.php ENDPATH**/ ?>