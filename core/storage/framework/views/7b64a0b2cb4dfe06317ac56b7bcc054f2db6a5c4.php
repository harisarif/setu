...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(get_image('assets/images/logoIcon/favicon.png')); ?>" sizes="16x16">
  <!-- bootstrap 4  -->
        ...
        <div class="row align-items-center">
          <div class="col-sm-6">
            <div class="left d-flex align-items-center">
              <a href="tel:65655655"><i class="las la-phone-volume"></i> <?php echo app('translator')->get('Help Center'); ?></a>
              <div class="language">
    ...
    <div class="header__bottom">
      <div class="container">
        ...
        <a class="site-logo site-title" href="<?php echo e(route('home')); ?>">
          <img src="<?php echo e(get_Image(imagePath()['logoIcon']['path'] .'/logo.png')); ?>" alt="site-logo" class="site-logo"><span class="logo-icon"><i class="flaticon-fire">
            </i></span></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="menu_has_children"><a href="<?php echo e(route('volunteer.list')); ?>"><?php echo app('translator')->get('Volunteers'); ?></a>

              </li>
            <li class="menu_has_children"><a href="<?php echo e(route('user.success.archive')); ?>"><?php echo app('translator')->get('Success Story'); ?></a>

              </li>
              <li class="menu_has_children"><a href="<?php echo e(route('user.team')); ?>"><?php echo app('translator')->get('Team'); ?></a>
...
<script src="<?php echo e(asset($activeTemplateTrue.'js/vendor/jquery-ui.min.js')); ?>"></script>
...
<?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/templates/basic/layouts/frontend.blade.php ENDPATH**/ ?>