                                                        ...
                                                        <div class="thumb">
                                                            ...
                                                            <div class="avatar-edit">
                                                                <input type="file" class="profilePicUpload"
                                                                       name="image_input[<?php echo e($imgKey); ?>]" id="profilePicUpload<?php echo e($loop->index); ?>"
                                                                       accept=".png, .jpg, .jpeg">
                                                ...
                                                <div class="input-group has_append">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary iconPicker"
                                                                        data-icon="<?php echo e(@$data->data_values->$k ? substr($data->data_values->$k,10,-6) : 'las la-home'); ?>" role="iconpicker"></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php else: ?>
                                    <?php if($type == 'textarea'): ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><?php echo e(inputTitle($k)); ?></label>
                                                <textarea rows="10" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" required><?php echo e(@$data->data_values->$k); ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <?php elseif($type == 'textarea-nic'): ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><?php echo e(inputTitle($k)); ?></label>
                                                <textarea rows="10" class="form-control nicEdit" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" ><?php echo e(@$data->data_values->$k); ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><?php echo e(inputTitle($k)); ?></label>
                                                <input type="text" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" value="<?php echo e(@$data->data_values->$k); ?>" required/>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/setu.foundation/public_html/core/resources/views/admin/frontend/element.blade.php ENDPATH**/ ?>