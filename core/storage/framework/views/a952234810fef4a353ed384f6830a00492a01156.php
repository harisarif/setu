        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Submitted By'); ?>">
                                        <?php if($item->user_id): ?>
                                        <a href="<?php echo e(route('admin.users.detail', $item->user_id)); ?>"> <?php echo e(optional($item->user)->fullname); ?></a>
                                        <?php else: ?>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                        <a href="<?php echo e(route('admin.ticket.view', $item->id)); ?>" class="icon-btn  ml-1" data-toggle="tooltip" title="" data-original-title="Details">
                ...
                <div class="card-footer py-4">
                    <?php echo e($items->links('admin.partials.paginate')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\setu\situ_foundation\core\resources\views/admin/support/tickets.blade.php ENDPATH**/ ?>