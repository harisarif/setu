                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="@lang('Status')">
                            <p class="{{$item->approval == 0 ? 'text-danger' :($item->approval==0 ? 'custom-font-error':'custom-font-error')}}">{{$item->approval == 0 ? 'Pending':($item->approval ? 'Approved':'Pending')}}</p>
                        </td>
                        <td data-label="@lang('Action')" class="text-center">
                        <a href="{{route('user.campaign.view',['slug'=>$item->slug,'id'=>$item->id])}}"><i class="fa fa-eye"></i></a>
                        </td>
                        
                    </tr>
                @empty
                <tr>
                    <td data-label="@lang('No Data')" colspan="100%">
                        <p class="text-center">
                            <i class="fas fa-laugh"></i>
                            @lang('No Pending Campaign')
                            <i class="fas fa-laugh"></i>
                        </p>
                    </td>
                </tr>
