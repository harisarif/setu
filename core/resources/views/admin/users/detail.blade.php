            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Balance')
                            <span class="font-weight-bold">{{getAmount($user->balance)}}  {{trans($general->cur_text)}}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.campaigns',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                            <span class="amount">{{$totalCampaign}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Campaign')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
