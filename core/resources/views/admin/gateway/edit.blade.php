                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <div class="input-group-prepend">
                                                                <div
                                                                    class="input-group-text">{{ $general->cur_text }}</div>
                                                            </div>
                                                            <input type="text" class="form-control"
                                                                   name="currency[{{ $currency_idx }}][min_amount]"
                                                                   value="{{ getAmount($gateway_currency->min_amount) }}"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0"
                                                                   ...
                                                                   value="{{ getAmount($gateway_currency->max_amount) }}"
                                                                   required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0"
                                                                   ...
                                                                   value="{{ getAmount($gateway_currency->fixed_charge) }}"
                                                                   required/>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0"
                                                                   ...
                                                                   value="{{ getAmount($gateway_currency->percent_charge) }}"
                                                                   required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           value="{{ $gateway_currency->currency }}"
                                                                           readonly/>
                                                                </div>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                ...
                                                                <div class="input-group-text"><span
                                                                        class="currency_symbol">{{ $gateway_currency->baseSymbol() }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        @foreach($parameters->where('global', false) as $key => $param)
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                                                                    <label class="w-100">{{ $param->title }} <span
                                                                            class="text-danger">*</span></label>
                                                                    <input disabled type="text" class="form-control"
                                                                           name="currency[{{ $currency_idx }}][param][{{ $key }}]"
                                                                           placeholder="---" required/>
