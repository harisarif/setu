    ...
    <div class="row mb-none-30">
            ...
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                <div class="icon">
                 ...
                 <div class="details">
                    ...
                    <span class="amount">{{$widget['total_campaign']}}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Campaign')</span>
                    </div>

                <a href="{{route('admin.fundrise.approved')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-7 b-radius--10 box-shadow" >
               ...
               <div class="details">
                    ...
                    <span class="currency-sign">{{$widget['total_donation']}} {{$general->cur_sym}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Donation')</span>
                    </div>

                    <a href="{{route('admin.donor')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--purple  b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                    <span class="amount">{{$widget['total_donor']}}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Donor')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
               ...
               <div class="details">
                    <div class="numbers">
                        <span class="amount">{{number_format($widget['total_withdraw'],2)}}</span>
                ...
                <a href="{{route('admin.withdraw.log')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            ...
                            <p  class="text--small">@lang('Number Of Donation')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            ...
                            <p class="text--small">@lang('Total Donation')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            ...
                            <p class="text--small">@lang('Total Donation Charge')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            ...
                            <p class="text--small">@lang('Pending Donation')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
            </div>
