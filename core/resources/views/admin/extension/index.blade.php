                            ...
                            @foreach($extensions as $extension)
                                <tr>
                                    <td data-label="@lang('Extension')">
                                        <div class="user">
                                            <div class="thumb"><img src="{{ getImage(imagePath()['extensions']['path'] .'/'. $extension->image,'36x36') }}" alt="{{ $extension->name }}" class="plugin_bg"></div>
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        <button type="button" class="icon-btn btn--dark ml-1 helpBtn"
                                                ...
                                                data-support="{{ $extension->support }}"
                                        ...
                                        @if($extension->status == 0)
                                            <button type="button"
                                                    ...
                                                    data-id="{{ $extension->id }}" data-name="{{ $extension->name }}"
                ...
                <form action="{{ route('admin.extensions.activate') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>@lang('Are you sure to activate') <span
                                    class="font-weight-bold extension-name"></span> @lang('extension?')</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
