                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" name="name" value="{{ $pdata->name }}"
                                required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" name="slug" value="{{ $pdata->slug }}"
                                required>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                <form action="{{route('admin.frontend.manage.section.update',$pdata->id)}}" method="post">
                    ...
                    <ol class="simple_with_drop vertical sec-item">
                        ...
                        <li class="highlight icon-move item">
                            ...
                            <span class="d-inline-block text-white mr-auto ml-2"> {{ @$sections[$sec]['name']}}</span>
            ...
            <div class="card-body">
                ...
                <ol class="simple_with_no_drop vertical">
                    ...
                    <li class="highlight icon-move clearfix">
                            ...
                            <span class="d-inline-block text-white mr-auto ml-2 mt-2"> {{$secs['name']}}</span>
                            <i class="ml-auto d-inline-block remove-icon fa fa-times"></i>
                            <input type="hidden" name="secs[]" value="{{$k}}">
                            @if($secs['builder'])
                                <div class="float-right d-inline-block manage-content">
                                    <a href="{{ route('admin.frontend.sections',$k) }}" target="_blank" class="btn btn-outline-light text-center text-white cog-btn"  data-toggle="tooltip" data-original-title="Manage Content">
