                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <small class="mt-2 text-facebook">@lang('Supported files:') <b>@lang('jpeg, jpg')</b>. @lang('Image will be resized into') {{imagePath()['seo']['size']}}px </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group ">
                                    ...
                                    <small class="ml-2 mt-2 text-facebook">@lang('Separate multiple keywords by') <code>,</code>@lang('(comma) or') <code>@lang('enter')</code> @lang('key')</small>
