                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-7">
                                <ul class="">
                                    <li>
                                        <h5>@lang('Language Keywords of') {{ $la->name }}</h5>
                                </ul>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="javascript:void(0)"
                                               ...
                                               data-key="{{$k}}"
                                               data-value="{{$lang}}"
                                               class="editModal icon-btn ml-1  " title=""
                                            ...
                                            <a href="javascript:void(0)"
                                               ...
                                               class="icon-btn btn--danger ml-1 deleteKey" title=""
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <select class="form-control select_lang"  required>
                            ...
                            <option value="{{$data->id}}" @if($data->id == $la->id) class="d-none" @endif >{{$data->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
