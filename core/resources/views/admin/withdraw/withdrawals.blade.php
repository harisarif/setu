    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-sm-6 mb-30">
            ...
            <div class="widget-two__content">
                <h2 class="text-white">{{ $general->cur_sym }}{{ $withdrawals->where('status',1)->sum('amount') }}</h2>
        ...
        <div class="col-xl-4 col-sm-6 mb-30">
            <div class="widget-two box--shadow2 b-radius--5 bg--6">
                <div class="widget-two__content">
                    <h2 class="text-white">{{ $general->cur_sym }}{{ $withdrawals->where('status',2)->sum('amount') }}</h2>
        ...
        <div class="col-xl-4 col-sm-6 mb-30">
            ...
            <div class="widget-two__content">
                <h2 class="text-white">{{ $general->cur_sym }}{{ $withdrawals->where('status',3)->sum('amount') }}</h2>
                            ...
                            @forelse($withdrawals as $withdraw)
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Method')"> 
                                       ...
                                       <a href="{{ route('admin.users.withdrawals.method',[$withdraw->method->id,@$type?$type:'all',$userId]) }}"> {{ optional($withdraw->method)->name }}</a>
                                       @else
                                       <a href="{{ route('admin.withdraw.method',[$withdraw->method->id,@$type]) }}"> {{ optional($withdraw->method)->name }}</a>
                                       @endif
                                    </td>
