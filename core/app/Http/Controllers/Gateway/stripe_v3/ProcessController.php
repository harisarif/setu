...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $session = \Stripe\Checkout\Session::create([
            ...
            'cancel_url' => route(gatewayRedirectUrl(), ['slug' => @$deposit->campaign->slug, 'id' => @$deposit->campaign->id]),
            'success_url' => route(gatewayRedirectUrl(), ['slug' => @$deposit->campaign->slug, 'id' => @$deposit->campaign->id]),
        ]);
