...
class DepositController extends Controller
{
    ...
    public function pending()
    {
        ...
        $empty_message = 'No pending Donations.';
        $type = 'pending';
    ...
    {
        $page_title = 'Approved Donations';
        $empty_message = 'No approved Donations.';
    ...
    {
        $page_title = 'Successful Donations';
        $empty_message = 'No successful Donations.';
    ...
    public function rejected()
    {
        ...
        $empty_message = 'No rejected Donations.';
        $type = 'rejected';
    ...
    public function deposit()
    {
        ...
        $empty_message = 'No Donations history available.';
    ...
    public function dateSearch(Request $request,$scope = null){
        ...
        $end = @$date[1];
        if ($start) {
            $deposits = Deposit::with(['user', 'gateway'])->where('status','!=',0)->where('created_at','>=',Carbon::parse($start));
        }
        if($end){
            $deposits = Deposit::with(['user', 'gateway'])->where('status','!=',0)->where('created_at','<=',Carbon::parse($end));
        }
        if ($request->method) {
    ...
    public function approve(Request $request)
    {
        ...
        $deposit->donation->payment_status = 1;
        $deposit->donation->save();
